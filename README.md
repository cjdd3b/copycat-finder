...
Using the parameters outlined above, the analysis revealed X clusters of similar bills


### Examples

Even this cursory analysis revealed hundreds of apparent model bills crafted by business and ideological groups, as well as providing a fascinating look into how lawmaking trends evolve and move between the states. Based on a very quick (and incomplete) read of the results, here are a few interesting finds:
